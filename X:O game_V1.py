## this code is an X/O game for two real players

# below is assighning the game board list to be used in printing the game board to the user & determining the game end
game_board = [1,2,3,4,5,6,7,8,9]


#turn variable is used to identify which player's turn to play
turn = 1

# winner_player is used to identify if either players have won yet
winner_player = 0
...
# assigning the other variable to the second player
if player1 == 'X':
    player2 = 'O'
else:
    player2 = 'X'
